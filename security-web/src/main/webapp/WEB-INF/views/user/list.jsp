  ...
  <!-- 这里的表单 name 必须是fenye -->
  	<div class="search_k" align="left">
		<fieldset class="search">
			<legend><img src="${pageContext.servletContext.contextPath }/images/search_btn.gif" align="middle"/>&nbsp;<span class="STYLE1" style="color: blue;">高级查找</span>
			<c:forEach var="resource" items="${resources}" >
					<a href="${pageContext.servletContext.contextPath }${resource.resUrl}">${resource.description}</a>
				</c:forEach></legend>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <td>${user1.userNickname}</td>
            <td>${user.regTime}</td>
            <td>${user1.lastLogintime}</td>
            <td>${user1.level}</td>
            <td><a href="javascript:void(0);" onclick="userRole('${user1.userId}')">分配角色</a>修改</td>
