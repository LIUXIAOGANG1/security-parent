  	...
  	<div class="search_k" align="left">
		<fieldset class="search">
			...
			<div class="search_content">
				名称：
<%-- 				<input type="text" name="name" value="${param.name}" style="height: 20px"/>　　 --%>
...
<!-- 	private String description; -->
          <tr>
          	 <td height="20" ><span class="STYLE1">${resource.id}</span></td>
          	 <td height="20" ><span class="STYLE1">${resource.name}</span></td>
          	 <td height="20" ><span class="STYLE1">${resource.parentId}</span></td>
          	 <td height="20" ><span class="STYLE1">${resource.resUrl}</span></td>
          	 <td height="20" ><span class="STYLE1">${resource.resKey}</span></td>
          	 <td height="20" ><span class="STYLE1">${resource.type}</span></td>
          	 <td height="20" ><span class="STYLE1">${resource.level}</span></td>
          	 
<%--           	 <td height="20" ><span class="STYLE1">${resource.description}</span></td>          --%>
          </tr>	
          </c:forEach>
  ...
  <tr>
    <td height="35" background="${pageContext.servletContext.contextPath }/images/tab_19.gif">
