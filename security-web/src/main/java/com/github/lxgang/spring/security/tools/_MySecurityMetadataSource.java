 ...
 * */
@Service
public class _MySecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
...
//		System.err.println("-----------MySecurityMetadataSource loadResourceDefine ----------- ");
		if (resourceMap == null) {
			...
			List<AgentResource> resources = resourcesDaoImpl.findAll();
			for (AgentResource resource : resources) {
				...
				ConfigAttribute configAttribute = new SecurityConfig("ROLE_" + resource.getResource());
